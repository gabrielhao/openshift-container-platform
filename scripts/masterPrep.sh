...
sudo subscription-manager register --force --insecure --username="$USERNAME_ORG" --password="$PASSWORD_ACT_KEY" || subscription-manager register --force --insecure --activationkey="$PASSWORD_ACT_KEY" --org="$USERNAME_ORG"
RETCODE=$?
