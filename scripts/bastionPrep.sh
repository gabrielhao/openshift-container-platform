...
subscription-manager register --insecure --username="$USERNAME_ORG" --password="$PASSWORD_ACT_KEY" || subscription-manager register --insecure --activationkey="$PASSWORD_ACT_KEY" --org="$USERNAME_ORG"
RETCODE=$?
